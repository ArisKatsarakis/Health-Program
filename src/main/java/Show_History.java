 ...
 */
@WebServlet(name = "Show_History" ,  value ="/Show_History")
public class Show_History extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Show_History</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Show_History at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String query = "update rendevouz set state = 'done' where id = '"
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String query = "select * from bloodtest where (amka) in (select amka from users where (username) in ("
                + "select username_pat from rendevouz where username_doc = '"+request.getParameter("username")+"' and"
                + " state = 'done'));";
        ...
        try{
            ...
            out.println("No randevouz were done recently");
        }
    }
